...
class View extends JPanel	//Extends JPanel to create a base for other graphical components.
{
	...
	public void paintComponent(Graphics g)
	{
		...
		//Was told that it was ok to do the above method for drawing mario, since
		//it is necessary for how I implemented sprites to stop being drawn when off screen.
		//I know the directions said something about not referencing mario though. 
	}
}