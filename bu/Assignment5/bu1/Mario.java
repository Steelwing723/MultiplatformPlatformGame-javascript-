...
class Mario extends Sprite
{
	...
	void tubeCollision(Sprite stationary)
	{
		...
		{															//if mario's feet were just at or above the 
				...
				|| y + h <= (stationary.y + stepValue))
			{
				...
				yShadow = y;
				// if(yShadow + h == stationary.y)	//if mario's last frame was on an object
				// {
	...
	void drawSelf(Graphics g)
	{
		...
		// //to invert:
		// if(flip)
			// g.drawImage(mario_image[mario_cycle], marioOffset + w, y, -w, h, null);
		// else
			// g.drawImage(mario_image[mario_cycle], marioOffset, y, w, h, null);
	}
